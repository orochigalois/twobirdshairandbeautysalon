...
// Include Constants    //
//////////////////////////
require_once(trailingslashit(get_template_directory()) . 'framework/constant.php');

//////////////////////////
// Include Autoloader   //
//////////////////////////
require_once(trailingslashit(get_template_directory()) . 'framework/autoload.php');
...
if( !function_exists('vp_ajax_wrapper') )
{
	function vp_ajax_wrapper()
	{
		...
		else
		{
			$result['data']    = '';
			$result['status']  = false;
			$result['message'] = esc_attr__("Unauthorized function", 'salon');		
		}
