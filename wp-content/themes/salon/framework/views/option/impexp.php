<div class="vp-field vp-textarea" data-vp-type="vp-textarea">
	<div class="label">
		<label>
			<?php esc_attr_e('Import', 'salon') ?>
		</label>
		<div class="description">
			<p><?php esc_attr_e('Import Options', 'salon') ?></p>
		</div>
	</div>
	<div class="field">
		<div class="input">
			...
			<div class="buttons">
				<input id="vp-js-import" class="vp-button button" type="button" value="<?php esc_attr_e('Import', 'salon') ?>" />
...
<div class="vp-field vp-textarea" data-vp-type="vp-textarea">
	<div class="label">
		<label>
			<?php esc_attr_e('Export', 'salon') ?>
		</label>
		<div class="description">
			<p><?php esc_attr_e('Export Options', 'salon') ?></p>
		</div>
	</div>
	<div class="field">
		<div class="input">
			...
			<div class="buttons">
				<input id="vp-js-export" class="vp-button button" type="button" value="<?php esc_attr_e('Export', 'salon') ?>" />
				<span style="margin-left: 10px;">
