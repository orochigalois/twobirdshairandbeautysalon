			...
			<div class="vp-sc-scroll-container">
				<div class="vp-sc-wrapper">
					...
					<?php foreach ($this->template as $title => $menu): ?>
						...
						<li class="current"><a href="#<?php echo esc_url(str_replace(' ', '_', $title)); ?>"><?php echo $title ?></li></a>
						<?php else: ?>
						<li><a href="#<?php echo esc_url(str_replace(' ', '_', $title)); ?>"><?php echo $title ?></li></a>
						<?php endif; ?>
					<?php endforeach; ?>
					</ul>
	...
	function print_form($attributes)
	{
		...
		foreach ($attributes as $attr)
		{
			...
			<?php if($attr['type'] !== 'notebox'): ?>
				<div class="vp-sc-field vp-<?php echo esc_attr($attr['type']); ?>" data-vp-type="vp-<?php echo $attr['type']; ?>">
		...
		<div class="vp-sc-action">
			<button class="vp-sc-insert button"><?php esc_attr_e('insert', 'salon'); ?></button>
			<button class="vp-sc-cancel button"><?php esc_attr_e('cancel', 'salon') ?></button>
		</div>
		<?php
	}
